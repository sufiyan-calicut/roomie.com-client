  ...
  return (
    <Layout>
      <div className='flex flex-col '>
        <button
          className='flex w-fit items-center gap-2 border px-4 py-2 m-4 bg-gradient-to-br from-emerald-900  to-emerald-800 text-gray-200 hover:border-red-900 duration-300 hover:bg-gray-50'
        ...
        <div className='bg-blac flex gap-8 items-center justify-center m-0'>
          <button
            className={`${
              selectedPeriods == 'day'
                ? 'border-b border-emerald-800 duration-300 '
                : 'border-b hover:border-emerald-800 duration-300 '
            }`}
            onClick={() => {
            ...
            <table className='table-fixed border-collapse w-full'>
              <thead>
                <tr className='bg-gray-200'>
                  ...
                  <th className='w-1/6 px-4 py-2 border'>Hotel Name</th>
                ...
                {data?.map((data, index) => {
                  return (
                    <tr key={index}>
                      ...
                      <td className='px-4 py-2 border text-center'>{data?.hotelData?.hotelName}</td>
